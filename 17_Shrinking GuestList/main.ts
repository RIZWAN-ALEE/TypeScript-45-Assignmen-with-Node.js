...
console.log(`Sorry, ${removeguest} I can’t invite you to nightout.`);
}
...
GuestList.forEach(lasttwo => console.log(`Luckly, ${lasttwo} you are still invited for the night out.`));
